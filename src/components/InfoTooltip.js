...
export default function InfoTooltip(props) {
  ...
  return (
    <div
      className={`popup popup_type_info-tooltip popup_transparent_slightly ${
        props.isOpen ? popupConfig.popupOpenedClass : ""
      }`}
    >
      <div className="page__container page__container_type_fixed-size-adaptive">
        ...
        ></button>
        <img
          src={props.infoTooltipContent.success ? successIcon : failureIcon}
          className="popup__confirm-icon"
          alt={
            props.infoTooltipContent.success
              ? intl.formatMessage({
                  id: "success_icon",
                  defaultMessage: "иконка успеха",
                })
              : intl.formatMessage({
                  id: "err_icon",
