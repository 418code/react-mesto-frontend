  ...
  return (
    <div
      className={`popup popup_type_${
        props.name
      } popup_transparent_medium ${props.isOpen &&
    ...
    >
      <div className="page__container">
        ...
        >
          <h2
            className={`page__form-title ${
              props.onlyTitle ? "page__form-title_onlytitle" : ""
            }`}
          >
            {props.formTitle}
          </h2>
          {props.children}
          <button
            className={`page__form-submit-btn ${
              props.isSubmitDisabled
                ? "page__form-submit-btn_disabled"
                : "transparent transparent_amount_much-more"
            }`}
            type="submit"
