...
export default function AddPlacePopup(props) {
  ...
  return (
    <PopupWithForm
      name={popupConfig.profileAddPopupAndFormName}
      formTitle={intl.formatMessage({
        id: "new_place",
        defaultMessage: "Новое место",
      })}
    ...
    >
      ...
      <input
        id="popup__place-url-input"
        type="url"
        name="url"
        className="page__form-text"
        placeholder={intl.formatMessage({
          id: "img_link",
          defaultMessage: "Ссылка на картинку",
        })}
        required="required"
        value={values["url"] || ""}
        onChange={handleChange}
