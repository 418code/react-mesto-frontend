  ...
  return (
    ...
    >
      <div className="enter__form-fields">
        <input
          id="enter__register-email-input"
          type="email"
          name="email"
        ...
        <input
          id="enter__register-password-input"
          type="password"
          name="password"
          className="page__form-text page__form-text_theme_black-box"
      ...
      <p className="page__form-bottom-text page__form-bottom-text_theme_black-box">
        ...
        <Link
          to="/sign-in"
          className="page__link page__link_size_small page__link_color_white transparent transparent_amount_more"
        >
