...
export default function Header(props) {
  ...
  return (
    <header className="header body__element">
      <img
        src={logo}
        alt={intl.formatMessage({ id: "logo", defaultMessage: "логотип" })}
      ...
      <Switch>
        ...
        <Route path="/sign-up">
          <Link
            to="/sign-in"
            className="page__link page__link_size_adaptive page__link_color_white transparent transparent_amount_more"
          >
